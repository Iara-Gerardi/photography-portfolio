...
export default function page() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full min-h-screen bg-black overflow-x-hidden">
      ...
      >
        ...
        >
          <Sections isScrollingBackRef={isScrollingBackRef} />
        </div>
      </div>
    </div>
  );
